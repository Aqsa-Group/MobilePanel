...
<body>
    <header class="fixed top-0 inset-x-0 w-full bg-white border-b border-gray-200 shadow-md z-[60]">
  <div class="w-full px-3 sm:px-6 lg:px-8">
    <div class="h-16 flex items-center justify-between">
      ...
      <div class="flex items-center gap-2 sm:gap-3">
        ...
        <button class="rounded-full bg-blue-200 border border-gray-200 p-2 hover:bg-gray-100 transition">
          <img src="/img/Icon Frame (1).png" class="w-5 h-5" alt="plus" />
        </button>

        <button class="rounded-full border bg-blue-200 border-gray-200 p-2 hover:bg-gray-100 w-9 h-9 transition relative">
        ...
        <!-- پروفایل -->
        <div class="relative">
          <button id="profileButton" class="flex items-center border border-blue-600 rounded-full p-1 gap-2 focus:outline-none">
...
<aside id="sidebar"
  class="fixed inset-y-0 right-0 z-40 w-48 bg-white border-l border-gray-200 shadow-md transform translate-x-full transition-transform duration-200 ease-out
  ...
  <nav id="menu" class="p-3 h-full flex flex-col justify-start ">
    ...
    <div class="space-y-1 mt-4">
      <a href="" data-section="dashboard"
        class="menu-btn group active w-full text-right flex items-center gap-3 rounded-xl px-5 py-2 text-sm transition bg-blue-600 text-white">
   ...
   style="cursor: pointer;">  
    ...
    <span>مشتریان</span>
      ...
      <a href="" data-section="mobiles"
        class="menu-btn group w-full text-right flex items-center gap-3 rounded-xl px-5 py-2 text-sm text-gray-700 transition hover:bg-blue-600 hover:text-white">
        <svg class="group-hover:fill-white" width="18" height="22" viewBox="0 0 18 22" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M16.75 5.75V15.75C16.75 19.75 15.75 20.75 11.75 20.75H5.75C1.75 20.75 0.75 19.75 0.75 15.75V5.75C0.75 1.75 1.75 0.75 5.75 0.75H11.75C15.75 0.75 16.75 1.75 16.75 5.75Z" stroke="#292D32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
          <path d="M10.75 4.25H6.75" stroke="#292D32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
          <path d="M8.74995 17.85C9.60599 17.85 10.3 17.156 10.3 16.3C10.3 15.444 9.60599 14.75 8.74995 14.75C7.89391 14.75 7.19995 15.444 7.19995 16.3C7.19995 17.156 7.89391 17.85 8.74995 17.85Z" stroke="#292D32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
        <span>موبایل ها</span>
      </a>
   ...
   style="cursor: pointer;">  
    <svg class="group-hover:fill-white" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M4.78003 8.30005V12.7001" stroke="#292D32" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
...
<a data-section="customers"
   ...
   <svg class="group-hover:fill-white" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
     ...
     <path d="M15.8501 9.92001C16.3701 9.66001 16.9401 9.52001 17.5201 9.51001" stroke="#292D32" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
   </svg>
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    menuButtons.forEach(btn => {
      btn.addEventListener('click', () => {
        ...
        if (window.innerWidth < 1024) close(); // بستن خودکار در موبایل
      });
    });
  });
</script>
