<div>
    <main class="max-w-full p-4 mx-auto  mt-2 ">
        @if (session()->has('message'))
            ...
            @endphp
            <div id="user-flash-modal" x-data="{ show: true }" x-init="setTimeout(() => show = false,3000)" x-show="show"  x-transition.opacity   class="fixed inset-0 flex items-center justify-center z-50" >
        ...
        @endif
        @if($canEdit)
        <div data-user-form-anchor></div>
        <div class="card w-full mx-auto shadow-[0px_4px_4px_0px_#00000040] border bg-white border-gray-300 rounded-lg  flex flex-col lg:flex-row">
            <div class="flex-1 lg:w-1/2 flex items-center justify-center p-3 sm:p-4 order-1 ">
                <div class="w-full max-w-full mx-auto">
                    ...
                    <div wire:key="form-wrapper-{{ $formResetKey }}">
                        <form  wire:submit.prevent="submit"  enctype="multipart/form-data"  class="space-y-3">
                            <div class="relative mx-auto w-24 h-24">
                                <div id="profileWrapper"
                                    ...
                                    @elseif($editingUser  && $editingUser->image)
                                        <img class="w-full h-full object-cover" src="{{ asset('storage/'.$editingUser->image) }}">
                            ...
                            @error('image')
                                <span class="block text-center text-red-500 text-xs px-2 mt-1">{{ $message }}</span>
                            @enderror
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-y-3 gap-3">
                                <div class="flex flex-col ">
                                    <div class="relative  w-full">
                                        <input type="text" placeholder="نام "  wire:model.defer="first_name" data-user-first-name="1" class="input-field ">
                                        <svg class="w-4 h-4 absolute left-2 top-1/2 -translate-y-1/2 svg-dark-light2" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M10.0002 10.0001C12.3013 10.0001 14.1668 8.1346 14.1668 5.83341C14.1668 3.53223 12.3013 1.66675 10.0002 1.66675C7.69898 1.66675 5.8335 3.53223 5.8335 5.83341C5.8335 8.1346 7.69898 10.0001 10.0002 10.0001Z" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                            <path d="M16.0085 13.1167L13.0585 16.0667C12.9418 16.1834 12.8335 16.4 12.8085 16.5584L12.6502 17.6833C12.5919 18.0917 12.8752 18.375 13.2835 18.3167L14.4085 18.1583C14.5668 18.1333 14.7919 18.025 14.9002 17.9084L17.8502 14.9584C18.3585 14.45 18.6002 13.8583 17.8502 13.1083C17.1085 12.3667 16.5169 12.6083 16.0085 13.1167Z" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                            <path d="M15.5835 13.5417C15.8335 14.4417 16.5335 15.1417 17.4335 15.3917" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                            <path d="M2.8418 18.3333C2.8418 15.1083 6.05015 12.5 10.0002 12.5C10.8668 12.5 11.7001 12.625 12.4751 12.8583" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                        </svg>
                                    </div>
                                    @error('first_name')
                                ...
                                <div class="flex flex-col ">
                                    <div class="relative  w-full">
                                        <input type="text" placeholder="نام فامیلی"   wire:model.defer="last_name"  class="input-field ">
                                        <svg class="w-4 h-4 absolute left-2 top-1/2  -translate-y-1/2 svg-dark-light2" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <path d="M15.5835 13.5417C15.8335 14.4417 16.5335 15.1417 17.4335 15.3917"  stroke-opacity="0.8" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M2.8418 18.3333C2.8418 15.1083 6.05015 12.5 10.0002 12.5C10.8668 12.5 11.7001 12.625 12.4751 12.8583"  stroke-opacity="0.8" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                        </svg>
                                    </div>
                                    @error('last_name')
                                        <span class=" text-red-500 text-xs px-2 mt-1">{{ $message }}</span>
                                ...
                                <div class="flex flex-col ">
                                    <div class="relative w-full">
                                        ...
                                        <svg class="w-4 h-4 absolute left-2 top-1/2 -translate-y-1/2 svg-dark-light2" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M5 21C5 17.134 8.13401 14 12 14C15.866 14 19 17.134 19 21M16 7C16 9.20914 14.2091 11 12 11C9.79086 11 8 9.20914 8 7C8 4.79086 9.79086 3 12 3C14.2091 3 16 4.79086 16 7Z" stroke="#292D32" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
                                    </div>
                                    @error('username')
                                        <span class=" text-red-500 text-xs px-2 mt-1">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="flex flex-col">
                                    <div class="relative  w-full">
                                        <input type="text" placeholder="آدرس" wire:model.defer="address" class="input-field ">
                                        <svg  class="w-4 h-4 absolute left-2 top-1/2  -translate-y-1/2 svg-dark-light2" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M1.6665 18.3333H18.3332"  stroke-opacity="0.8" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M2.4585 18.3334L2.50017 8.30836C2.50017 7.80003 2.74183 7.31674 3.14183 7.00008L8.97516 2.4584C9.57516 1.99173 10.4168 1.99173 11.0252 2.4584L16.8585 6.99173C17.2668 7.3084 17.5002 7.7917 17.5002 8.30836V18.3334"  stroke-opacity="0.8" stroke-width="1.5" stroke-miterlimit="10" stroke-linejoin="round"/>
                                        <path d="M12.9168 9.16675H7.0835C6.39183 9.16675 5.8335 9.72508 5.8335 10.4167V18.3334H14.1668V10.4167C14.1668 9.72508 13.6085 9.16675 12.9168 9.16675Z"  stroke-opacity="0.8" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M8.3335 13.5417V14.7917"  stroke-opacity="0.8" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M8.75 6.25H11.25"  stroke-opacity="0.8" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                        </svg>
                                    </div>
                                    @error('address')
                                        <span class=" text-red-500 text-xs px-2 mt-1">{{ $message }}</span>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-y-3 gap-3">
                                ...
                                <div class="flex flex-col ">
                                    @if(auth()->user()->rule === 'super_admin' && $rule === 'admin')
                                        <select class="text-gray-500 input-field cursor-pointer flex " wire:model.defer="limit">
                            ...
                            <div class="md:col-span-2 flex flex-col md:flex-row gap-2">
                                ...
                                {{ $editMode? 'ویرایش کاربر' : 'ایجاد کاربر' }}
                                </button>
                            </div>
                        </form>
                    </div>
        ...
        @endif
        <section class="card w-full  mt-2 bg-white  mx-auto h-full flex flex-col border  border-gray-300  rounded-lg  shadow-[0px_4px_4px_0px_#00000040] p-2  items-center">
            <div class="flex flex-col md:flex-row justify-between items-center w-full mt-1 gap-1 md:gap-2">
                <div class="flex gap-2 w-full ">
                    <div class="relative   w-full  md:w-1/4  ">
                        <input type="text"  wire:model.live="search" class="w-full h-full block rounded-md md:rounded-lg input-dark-light md:absolute md:top-0 md:right-0 pr-2 text-[7px] sm:p-6 p-4  md:text-[10px]" placeholder="جستجو">
                        <span class="absolute md:hidden left-1  top-3">
                            <svg width="14" height="14" viewBox="0 0 19 19" fill="none"  xmlns="http://www.w3.org/2000/svg" class="svg-dark-light">
                                <path
                                ...
                                <path d="M5.80448 15.5554L6.96533 14.3945"
                                    stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                        </span>
                        <span class="hidden md:block absolute left-2 top-4">
                            <svg width="19" height="19" viewBox="0 0 19 19" fill="none"  xmlns="http://www.w3.org/2000/svg" class="svg-dark-light">
                                <path
                                    d="M11.899 14.9749C8.8537 14.9749 6.38498 12.5062 6.38498 9.46083C6.38498 6.4155 8.8537 3.94678 11.899 3.94678C14.9444 3.94678 17.4131 6.4155 17.4131 9.46083C17.4131 12.5062 14.9444 14.9749 11.899 14.9749Z"
                    ...
                    <table class="w-full text-center border-separate border-spacing-0 text-lg" style="font-style: Regular;">
                        ...
                        <tbody class="[&>tr:not(:last-child)>td]:border-b [&>tr:not(:last-child)>td]:border-blue-800 text-[10px]">
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($user->rule === 'user')
                                        <span class="role-user">کاربر</span>
                                    @elseif($user->rule === 'admin')
                                        <span class="role-admin">ادمین</span>
                                    @else
                                        <span class="role-superadmin">سوپر ادمین</span>
                                    @endif
                                </td>
                                @if(auth()->user()->rule !== 'user')
                                <td>
                                ...
                                <td class="text-center">
                                    <button type="button" onclick="scrollToUserListForm();" wire:click="editUser({{ $user->id }})" class="flex items-center justify-center mx-auto h-full">
                                        <svg class="icon-blue" width="20" height="20" viewBox="0 0 24 24" fill="none"  xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="print-area mt-2 md:hidden flex flex-col  px-2 gap-2 w-full">
                    ...
                    <div class="rounded-xl flex   flex-col items-center  border border-[#1E40AF66] h-auto w-full">
                        ...
                        <div  class="flex flex-row gap-2 my-2 w-full px-4 mt-4">
                            ...
                            <button type="button" onclick="scrollToUserListForm();" wire:click="editUser({{ $user->id }})" class="flex justify-center items-center gap-1 border rounded-lg border-[#0033BB] w-1/2 h-[30px] text-[#0033BB] text-[10px]">
                            ...
                            <button  type="button"  wire:click="confirmDelete({{ $user->id }})" class="flex justify-center items-center gap-1 border rounded-lg border-[#FF0000] text-white w-1/2 h-[30px] text-[#FF0000] text-[10px]">
                                <svg class="icon-danger"  width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path d="M18.8499 9.14001L18.1999 19.21C18.0899 20.78 17.9999 22 15.2099 22H8.7899C5.9999 22 5.9099 20.78 5.7999 19.21L5.1499 9.14001"  stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <script>
            function initUserListFlashAutoHide() {
                const modal = document.getElementById('user-flash-modal');
                if (!modal || modal.dataset.autoHideAttached === '1') {
                    return;
                }
                modal.dataset.autoHideAttached = '1';
                setTimeout(() => {
            ...
            function scrollToUserListForm() {
                const anchor = document.querySelector('[data-user-form-anchor]');
                if (!anchor) {
                    return;
                }
                anchor.scrollIntoView({ behavior: 'smooth', block: 'start' });
                setTimeout(() => {
                    const firstInput = document.querySelector('[data-user-first-name]');
                    if (firstInput) {
                        firstInput.focus();
                    }
                }, 250);
            ...
            document.addEventListener('DOMContentLoaded', initUserListFlashAutoHide);
            window.addEventListener('scrollToUserForm', scrollToUserListForm);
            ...
            if (!window.__userListFlashObserverBound) {
                window.__userListFlashObserverBound = true;
                const observer = new MutationObserver(() => {
                    initUserListFlashAutoHide();
                });
