                    ...
                    <div wire:key="form-wrapper-{{ $formResetKey }}">
                        <form  wire:submit.prevent="submit"  enctype="multipart/form-data"  class="space-y-3">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-y-3 gap-3">
                                <div class="flex flex-col ">
                                    <div class="relative  w-full">
                                        <input type="text" placeholder="نام "  wire:model.live="first_name"    class="input-field ">
                                ...
                                <div class="flex flex-col ">
                                    <div class="relative  w-full">
                                        <input type="text" placeholder="نام فامیلی"   wire:model.live="last_name"  class="input-field ">
                                        <svg class="w-4 h-4 absolute left-2 top-1/2  -translate-y-1/2 svg-dark-light2" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="flex flex-col ">
                                    <div class="relative w-full">
                                        <input type="text" placeholder="نام کاربری" wire:model.live="username"  class="input-field ">
                                ...
                                <div class="flex flex-col">
                                    <div class="relative  w-full">
                                        <input type="text" placeholder="آدرس" wire:model.live="address" class="input-field ">
                                        <svg  class="w-4 h-4 absolute left-2 top-1/2  -translate-y-1/2 svg-dark-light2" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-y-3 gap-3">
                                <div class="flex flex-col ">
                                    <div class="relative w-full">
                                        <input type="tel" placeholder="شماره" wire:model.live="number"
                                            class="input-field ">
                                        <svg class="w-4 h-4 absolute left-2 top-1/2  -translate-y-1/2 svg-dark-light2" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="flex flex-col">
                                    <div class="relative  w-full">
                                        <input type="email" placeholder=" ایمیل" wire:model.live="email"
                                            class="input-field ">
                                ...
                                <div class="flex flex-col ">
                                    <div class="relative w-full">
                                        <input type="password" placeholder="پسورد"  wire:model.live="password"
                                            class="input-field ">
                                ...
                                <div class="flex flex-col ">
                                    @if(auth()->user()->rule === 'super_admin' && $rule === 'admin')
                                        <select class="text-gray-500 input-field cursor-pointer flex " wire:model.live="limit">
