                ...
                <div class="w-full max-w-full mx-auto">
                    ...
                    <form wire:submit.prevent="submit"  enctype="multipart/form-data"  class="space-y-3">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-y-3 gap-3">
                            <div class="flex flex-col ">
                                <div class="relative  w-full">
                                    <input type="text" placeholder="نام "  wire:model.defer="first_name"    class="input-field ">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-y-3 gap-3">
                            ...
                            <div class="flex flex-col ">
                                <select wire:model.defer="rule" class="  text-gray-500 input-field cursor-pointer flex  ">
