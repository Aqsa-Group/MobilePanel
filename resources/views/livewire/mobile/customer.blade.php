                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-y-10 gap-3">
                            <div class="flex flex-col ">
                                <div class="relative w-full">
                                    <label for="imageUpload" class="text-gray-500 input-field cursor-pointer flex   bg-white  ">
                            ...
                            <div class="flex flex-col">
                                <div class="relative w-full">
                                    <input type="text" placeholder="نام کامل"  wire:model.lazy="fullname"  wire:model="name"
                                        class="input-field ">
                                    <svg class="w-4 h-4 absolute left-2 top-1/2 -translate-y-1/2 text-gray-500" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="flex flex-col">
                                <div class="relative w-full">
                                    <input type="tel" placeholder="شماره" wire:model="customer_number"  wire:model.lazy="customer_number"
                                        class="input-field ">
                                    <svg class="w-4 h-4 absolute left-2 top-1/2 -translate-y-1/2 text-gray-500" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="flex flex-col">
                                <div class="relative  w-full">
                                    <input type="text" placeholder="آیدی تذکره" wire:model="id_card" wire:model.lazy="id_card"
                                        class="input-field ">
                                    <svg class="w-4 h-4 absolute left-2 top-1/2 -translate-y-1/2 text-gray-500" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="relative">
                                <select wire:model="customer_type" class="bg-white input-field  ">
