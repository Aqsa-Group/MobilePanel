                        ...
                        <div class="flex flex-col">
                            <div class="relative mx-auto w-24 h-24">
                                <div id="profileWrapper" onclick="document.getElementById('profile_image').click()"
                                    ...
                                    @elseif ($oldImage)
                                        <img class="w-full h-full object-cover" src="{{ asset('storage/'.$oldImage) }}">
                                    @else
                            ...
                            @error('image')<span class="text-red-500 text-sm px-2 mt-1 text-center block">{{ $message }}</span>@enderror
                        </div>
