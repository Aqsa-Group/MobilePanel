<div class="w-full p-4 max-w-full mx-auto">
    <div class="rounded-lg shadow-xl w-full card shadow-[0px_4px_4px_0px_#00000040] bg-white border  border-gray-300 px-2 py-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="flex flex-col ">
                    <div class="relative w-full">
                        ...
                        <svg class="w-4 h-4 absolute left-2 top-1/2  -translate-y-1/2 svg-dark-light2" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="grid grid-cols-1  w-full lg:grid-cols-2 gap-3 pt-2">
        <div class="lg:col-span-2 border card border-gray-300 bg-white rounded-lg shadow-[0px_4px_4px_0px_#00000040] shadow-xl  w-full lg:max-w-full p-3">
            <div class="flex flex-col md:flex-row justify-between items-center w-full mt-1 gap-1 md:gap-2">
                <div class="flex gap-2 w-full ">
                    <div class="relative   w-full  md:w-1/4  ">
                        <input type="text"  wire:model.live="search" class="w-full h-full block rounded-md md:rounded-lg input-dark-light  md:top-0 md:right-0 pr-2 text-[7px] sm:p-4  p-4  md:text-[10px]" placeholder="جستجو">
                        <span class="absolute md:hidden left-1  top-3">
                            <svg  width="14" height="14" viewBox="0 0 19 19" fill="none" class="svg-dark-light"
                ...
                <table class="w-full text-center  text-sm border-collapse">
                    ...
                    <tbody>
                        ...
                        <tr class=" text-[10px] border-b-2 border-blue-800">
                            ...
                            <td class="p-2">
                                <button type="button" onclick="printSingleRow(this)">
            ...
            <div class=" rounded-2xl shadow-xl sm:hidden block p-3">
                ...
                <div class="flex justify-center items-center gap-2 mt-3">
                    <div class="flex  gap-3 mt-5">
                        <button type="button" onclick="printSingleRow(this)" class="flex items-center gap-1  border border-2 border-gray-600 py-2 px-3 rounded-lg text-xs">
