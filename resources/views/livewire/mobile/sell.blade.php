        ...
        <div class="bg-[#0B35CC]/10 w-full rounded-2xl space-y-3 p-4 border-r-[3px] border-[#0B35CC] shadow-xl shadow-[0px_4px_4px_0px_#00000040]">
            ...
            <div class="space-y-10">
                <div class="flex justify-between items-center">
                    ...
                    <span class="text-lg text-[#0B35CC] font-bold">{{ $totalCount }}</span>
                </div>
                <div class="flex justify-between items-center">
        ...
        <div class="bg-[#0099FF]/10 w-full rounded-2xl space-y-3 p-4 border-r-[3px] border-[#0099FF] shadow-xl shadow-[0px_4px_4px_0px_#00000040]">
            ...
            <div class="space-y-10">
                <div class="flex justify-between items-center">
                    ...
                    <span class="text-lg text-[#0099FF] font-bold">{{ $todayCount }}</span>
                </div>
                <div class="flex justify-between items-center">
        ...
        <div class="bg-[#31009B]/10 w-full rounded-2xl space-y-3 p-4 border-r-[3px] border-[#31009B] shadow-xl shadow-[0px_4px_4px_0px_#00000040]">
            ...
            <div class="space-y-10">
                <div class="flex justify-between items-center">
                    ...
                    <span class="text-lg text-[#31009B] font-bold">{{ $weekCount }}</span>
                </div>
                <div class="flex justify-between items-center">
        ...
        <div class="bg-[#3A64D0]/10 w-full rounded-2xl space-y-3 p-4 border-r-[3px] border-[#3A64D0] shadow-xl shadow-[0px_4px_4px_0px_#00000040]">
            ...
            <div class="space-y-10">
                <div class="flex justify-between items-center">
                    ...
                    <span class="text-lg text-[#3A64D0] font-bold">{{ $monthCount }}</span>
                </div>
                <div class="flex justify-between items-center">
                ...
                <div class="flex justify-between items-center mb-3 flex-wrap gap-2">
                        ...
                        <div class="flex gap-2 w-full">
                            <div class="bg-[#1E40AF] text-white p-2 rounded-lg flex gap-1 items-center cursor-pointer">
                                <a href="{{ route('sellform') }}"  class="flex items-center gap-1 p-2 bg-[#1E40AF] text-white rounded-lg cursor-pointer">
                        ...
                        <div class="grid grid-cols-2 text-center gap-5 text-sm">
                            <div>
                                <div class="text-gray-900 font-bold">
                                    @if($sale->device?->image_path)
                                        <img src="{{ asset('storage/' . $sale->device->image_path) }}" class="w-16 h-16 rounded-lg object-cover">
                                    @else
                                        <span class="text-gray-400">بدون عکس</span>
                                    @endif
                                </div>
                            </div>
                            <div>
                                <div class="text-gray-900 font-bold">
                                    @if($sale->customer?->image_path)
                                        <img src="{{ asset('storage/' . $sale->customer->image_path) }}" class="w-16 h-16 rounded-full object-cover">
                                    @else
                                        <span class="text-gray-400">بدون عکس</span>
                                    @endif
                                </div>
                            ...
                            <div>
                                ...
                                <div class="text-gray-900 font-bold">{{ $sale->customer->name }}</div>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <div class="text-gray-900 font-bold">@if($customer->admin)     {{ $customer->admin->name }} ({{ $customer->admin->rule }})  @else     -- @endif</div>
                            </div>
                            <div>
                                <div class="text-gray-600 text-xs font-semibold mb-1">تاریخ</div>
                                <div class="text-gray-900 font-bold">{{ \Carbon\Carbon::parse($sale->created_at)->format('Y/m/d') }}</div>
                            </div>
                            <div>
                                <div class="text-gray-600 text-xs font-semibold mb-1">مدل دستگاه</div>
                                <div class="text-gray-900 font-bold">{{ $sale->device->model }}</div>
                            </div>
                            <div>
                                <div class="text-gray-600 text-xs font-semibold mb-1">مبلغ</div>
                                <div class="text-gray-900 font-bold">{{ number_format($sale->price) }}؋</div>
                            </div>
                        </div>
                        <div class="flex justify-center gap-3 mt-5">
                            <div  class="text-center">
                                <div class="text-gray-600 text-xs font-semibold mb-1">شمارهIMEI</div>
                                <div class="text-gray-900 text-center font-bold">{{ $sale->imei }}  </div>
                            </div>
                        </div>
                        <div class="flex justify-center gap-3 mt-5">
                    ...
                    <div class="flex flex-col lg:flex-row gap-2 items-center">
                        ...
                        <div class="flex-none">
                            <a href="{{ route('sellform') }}" class="flex items-center gap-1 px-3 py-2 bg-[#1E40AF] text-white rounded-lg cursor-pointer whitespace-nowrap">
                                ...
                                <span class="hidden md:inline text-[10px] truncate">اضافه کردن فروش جدید</span>
                            </a>
                        </div>
                    </div>
                </div>
                <table class="w-full text-center text-sm border-collapse">
                    <thead class="bg-[#1E40AF] text-white border-b-2 border-[#1E40AF]">
                        <tr>
                            ...
                            <th class="p-2 text-[12px] text-center">عکس دستگاه </th>
                            <th class="p-2 text-[12px] text-center">نام مشتری </th>
                            <th class="p-2 text-[12px] text-center">عکس مشتری </th>
                            <th class="p-2 text-[12px] text-center"> آیدی تذکره مشتری </th>
                            <th class="p-2 text-[12px] text-center">تاریخ فروش</th>
                            <th class="p-2 text-[12px] text-center">مبلغ</th>
                    ...
                    <tbody>
                        ...
                        <tr class="text-[11px] border-b-2 border-[#1E40AF]">
                            <td class="p-2 font-bold">{{ $sale->id }}</td>
                            <td class="p-2"> {{ $sale->device->model }}</td>
                            <td class="p-2">     @if($sale->device?->image_path)
                                <img src="{{ asset('storage/' . $sale->device->image_path) }}" class="w-16 h-16 rounded-lg object-cover">
                                @else
                                    <span class="text-gray-400">بدون عکس</span>
                                @endif
                            ...
                            <td class="p-2">{{ \Carbon\Carbon::parse($sale->created_at)->format('Y/m/d') }}</td>
                            <td class="p-2">{{ number_format($sale->price) }}؋</td>
                            <td class="p-2">{{ $sale->imei }}</td>
                            <td class="p-2"> @if($sale->customer?->admin)
                                {{ $sale->customer->admin->name }}
                                ({{ $sale->customer->admin->role ?? '' }})
                            @else
                                --
                            @endif
                            </td>
