...
<div class="max-w-full mx-auto p-4">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        <div class="bg-[#6D28D9]/10 border-r-4 border-[#6D28D9] text-[#6D28D9] p-6 rounded-xl shadow-lg transition-all duration-300 hover:shadow-xl">
            <div class="flex items-center justify-between mb-4">
                <h3 class="text-lg font-bold"> موجودی دوکان </h3>
                <div class="bg-[#6D28D9] p-2 rounded-full">
            ...
            <div class="space-y-10">
                <div class="flex justify-between items-center">
                    <span class="text-sm text-[#6D28D9]">افغانی:</span>
                    <span class="text-lg font-bold">{{ number_format($shopBalanceAFN) }}؋</span>
                </div>
                <div class="flex justify-between items-center">
                    <span class="text-sm text-[#6D28D9]">دالر:</span>
                    <span class="text-lg font-bold">${{ number_format($shopBalanceUSD) }}</span>
                </div>
            </div>
        </div>
        <div   class="bg-[#312E81]/10 border-r-4 border-[#312E81] text-[#312E81] p-6 rounded-xl shadow-lg transition-all duration-300 hover:shadow-xl">
            <div class="flex items-center justify-between mb-4">
                <h3 class="text-lg font-bold"> موجودی گدام </h3>
                <div class="bg-[#312E81] p-2 rounded-full">
            ...
            <div class="space-y-10">
                <div class="flex justify-between items-center">
                    <span class="text-sm text-[#312E81]">افغانی:</span>
                    <span class="text-lg font-bold">{{ number_format($warehouseBalanceAFN) }}؋</span>
                </div>
                <div class="flex justify-between items-center">
                    <span class="text-sm text-[#312E81]">دالر:</span>
                    <span class="text-lg font-bold">${{ number_format($warehouseBalanceUSD) }}</span>
                </div>
            </div>
        </div>
