...
<div class="p-3 ">
    ...
    <div class="grid grid-cols-1  max-w-full mx-auto lg:grid-cols-3 gap-3">
        <div wire:key="{{ $formKey }}" >
            <form   wire:submit.prevent="save" class="h-full   mb-6 space-y-2">
                <div class=" rounded-2xl shadow-xl border card border-gray-300 shadow-[0px_4px_4px_0px_#00000040] border border-gray-200 w-full lg:max-w-full p-3">
                    ...
                    <div class="flex  flex-col">
                        <select wire:model="withdrawal_type" class="w-full rounded-xl border input-field p-4 box-border text-sm mb-3 ">
                            <option  value="" >نوع برداشت</option>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 mb-3">
                        <div class="flex flex-col">
                            <div class="border box-border rounded-xl p-4 input-field flex items-center gap-2">
                                <input wire:model="amount" type="text" placeholder="مبلغ" class="w-full bg-transparent focus:outline-none no-spinner text-sm">
                                <i>
                    ...
                    <textarea wire:model="description" class="w-full rounded-xl border  input-field p-2 text-sm h-28 " placeholder="توضیحات..."></textarea>
                    @error('description')
                        <span class=" text-red-500 text-[8px] px-2 mt-1">{{ $message }}</span>
                    @enderror
        ...
        <div class="lg:col-span-2 border card border-gray-300 rounded-2xl shadow-[0_4px_12px] shadow-lg border border-gray-200 w-full lg:max-w-full p-3">
                        ...
                        <div class="rounded-2xl flex flex-col items-center mt-2 border border-[#1E40AF] h-auto w-full my-4">
                            <table dir="ltr" class="w-full table-fixed items-center font-semibold justify-center text-center mx-auto">
                                ...
                                <button wire:click="edit({{ $withdrawal->id }})"  class="flex justify-center border items-center rounded-lg border-[#1E40AF] w-1/2 h-[25px] text-[#1E40AF] text-[10px]">
                                    <svg width="15" height="15" viewBox="0 0 24 24" class="icon-blue" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <tbody>
                        ...
                        <tr class="text-[11px]  border-b-2 border-[#1E40AF]">
                            ...
                            <td class="p-2 text-center ">
                                <button type="button" onclick="printSingleRow(this)" class="mx-auto block ">
                                    <svg width="20" height="20" viewBox="0 0 24 24" class="icon-dark-light" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M9 10H6" stroke-width="1.5" stroke-linecap="round"></path> <path d="M19 14L5 14" stroke-width="1.5" stroke-linecap="round"></path> <circle cx="17" cy="10" r="1" fill="currentColor"></circle> <path d="M15 16.5H9"  stroke-width="1.5" stroke-linecap="round"></path> <path d="M13 19H9" stroke-width="1.5" stroke-linecap="round"></path> <path d="M22 12C22 14.8284 22 16.2426 21.1213 17.1213C20.48 17.7626 19.5535 17.9359 18 17.9827M6 17.9827C4.44655 17.9359 3.51998 17.7626 2.87868 17.1213C2 16.2426 2 14.8284 2 12C2 9.17157 2 7.75736 2.87868 6.87868C3.75736 6 5.17157 6 8 6H16C18.8284 6 20.2426 6 21.1213 6.87868C21.4211 7.17848 21.6186 7.54062 21.7487 8"  stroke-width="1.5" stroke-linecap="round"></path> <path d="M17.9827 6C17.9359 4.44655 17.7626 3.51998 17.1213 2.87868C16.2426 2 14.8284 2 12 2C9.17157 2 7.75736 2 6.87868 2.87868C6.23738 3.51998 6.06413 4.44655 6.01732 6M18 15V16C18 18.8284 18 20.2426 17.1213 21.1213C16.48 21.7626 15.5535 21.9359 14 21.9827M6 15V16C6 18.8284 6 20.2426 6.87868 21.1213C7.51998 21.7626 8.44655 21.9359 10 21.9827" stroke-width="1.5" stroke-linecap="round"></path> </g></svg>
                                </button>
                            </td>
                            <td class="p-2 text-center">
                                <button type="button"  wire:click="edit({{ $withdrawal->id }})"  class="mx-auto icon-blue block">
