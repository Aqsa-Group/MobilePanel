        ...
        <div class="gap-4 grid grid-cols-1 md:grid-cols-4 w-full">
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <div class="bg-[#0066E433] rounded-full p-1">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M8.80005 11.2207H22" stroke="#0066E4" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                ...
                                <path d="M11.3201 15.2607H12.6501" stroke="#0066E4" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M14.75 15.2607H18.02" stroke="#0066E4" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                        </div>
                    </div>
                    <div class="flex flex-col justify-center items-center">
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <div class="bg-[#0099FF33] rounded-full p-1">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M22.0016 10.9102H14.3516" stroke="#0099FF" stroke-width="1.5" stroke-miterlimit="10"/>
                                <path d="M9.64999 10.9102H2" stroke="#0099FF" stroke-width="1.5" stroke-miterlimit="10"/>
                            </svg>
                        </div>
                    </div>
                    <div class="flex flex-col justify-center items-center">
            ...
            <div class="flex flex-row md:flex-col gap-6">
                ...
                <div class="bg-[#009B10]/10 w-full md:w-50 mx-auto rounded-xl space-y-3 p-3 border-r-[2px]  border-[#009B10] shadow-xl shadow-[0px_4px_4px_0px_#00000040] transition-all duration-200 hover:scale-105 cursor-pointer">
                    ...
                    <div class="flex flex-col justify-center items-center">
                        <h1 class="font-bold">75,000؋</h1>
                        <h1 class="text-xs">مبلغ باقی مانده این ماه</h1>
                    </div>
                </div>
            </div>
            <div class="flex flex-row md:flex-col gap-6">
...
<div class="grid grid-cols-1 max-w-7xl lg:grid-cols-3 gap-3 p-2">
        ...
        <div class="lg:hidden space-y-3 ">
            ...
            <div class="flex gap-2 flex-1 min-w-[100px]">
                ...
                <div class="relative flex-1">
                    ...
                    <input type="text" class="p-1 pr-8 w-full shadow border border-2 bg-[#0B35CC]/20 rounded-xl" placeholder="فیلتر">
                </div>
                <!-- جستجو -->
                <div class="relative flex-1">
                    <input type="text" class="p-1 w-full shadow bg-[#0B35CC]/20 border border-2 rounded-xl" placeholder="جستجو....">
