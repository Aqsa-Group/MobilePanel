<div>
    <div class="text-gray-800 flex items-center max-w-full mt-3 mx-auto justify-center p-3 sm:p-4">
        ...
        <div class="animate-fade-slide w-full   overflow-x-hidden p-2 shadow-[0px_4px_4px_0px_#00000040] bg-[#616161]/5 rounded-2xl shadow-xl overflow-hidden flex flex-col lg:flex-row opacity-0 transform translate-y-10">
            <!-- ستون فرم -->
