                    ...
                    @foreach($loan_models as $index => $model)
                        ...
                        <div class="">
                            ...
                            <div class="flex flex-col md:flex-row gap-4 mt-2">
                                <div class="relative w-full md:w-1/2">
                                    <span class="absolute left-3 top-3 text-gray-400">
                                        <svg fill="#000000" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="24" height="24"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M77,58.48H56.47a1.63,1.63,0,0,0-1.63,1.63h0v1.64a1.65,1.65,0,0,0,1.63,1.64H77a1.65,1.65,0,0,0,1.63-1.64V60.11A1.63,1.63,0,0,0,77,58.48Z"></path> <path d="M77,70H56.47a1.65,1.65,0,0,0-1.63,1.64v1.64a1.63,1.63,0,0,0,1.63,1.63H77a1.63,1.63,0,0,0,1.63-1.63V71.63A1.64,1.64,0,0,0,77,70Z"></path> <path d="M43.55,58.48H23a1.65,1.65,0,0,0-1.64,1.63v1.64A1.66,1.66,0,0,0,23,63.39H43.55a1.66,1.66,0,0,0,1.64-1.64V60.11A1.65,1.65,0,0,0,43.55,58.48Z"></path> <path d="M43.55,70H23a1.66,1.66,0,0,0-1.64,1.64v1.64A1.64,1.64,0,0,0,23,74.9H43.55a1.65,1.65,0,0,0,1.64-1.63V71.63A1.65,1.65,0,0,0,43.55,70Z"></path> <path d="M66.73,25.14a13,13,0,1,0,13,13A13,13,0,0,0,66.73,25.14ZM73.17,39a.82.82,0,0,1-.82.7H61.11a.78.78,0,0,1-.81-.7,11.3,11.3,0,0,1,0-1.84.82.82,0,0,1,.81-.7H72.35a.82.82,0,0,1,.82.7A11.3,11.3,0,0,1,73.17,39Z"></path> <path d="M42.51,28.88A13,13,0,0,0,24.08,47.31h0A13,13,0,0,0,42.51,28.88ZM42,39.17a.51.51,0,0,1-.47.55H35.46a.58.58,0,0,0-.54.54v6a.58.58,0,0,1-.54.54H32.21a.5.5,0,0,1-.54-.46V40.26a.51.51,0,0,0-.48-.54H25.12a.52.52,0,0,1-.54-.5V37a.59.59,0,0,1,.54-.55h6a.51.51,0,0,0,.55-.47V30a.58.58,0,0,1,.54-.54h2.17a.54.54,0,0,1,.54.54h0v6a.5.5,0,0,0,.46.54h6.08A.6.6,0,0,1,42,37Z"></path> </g></svg>
                                    </span>
                                    <input type="text" inputmode="numeric" wire:model.live="loan_quantities.{{ $index }}" class="input-field no-spinner" placeholder="تعداد">
                                    @error("loan_quantities.$index")
                                        <span class="text-red-600 text-xs">{{ $message }}</span>
                                    @enderror
                                </div>
                            </div>
                    ...
                    @foreach($cash_items as $i => $row)
                        ...
                        <div class="flex flex-col md:flex-row gap-4 mb-2">
                            <div class="relative w-full md:w-1/2">
                                ...
                                <input type="text" inputmode="numeric" wire:model.live="cash_items.{{ $i }}.quantity" class="input-field no-spinner" placeholder="تعداد">
                                @error("cash_items.$i.quantity")
                                    <span class="text-red-600 text-xs">{{ $message }}</span>
                                @enderror
                            </div>
                        </div>
