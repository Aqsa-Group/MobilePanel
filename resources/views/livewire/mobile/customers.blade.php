        ...
        <section class="shadow-xl shadow-[0px_4px_4px_0px_#00000040] m-2 md:mt-6 h-auto flex flex-col border bg-white border-gray-300 rounded-2xl  p-2  items-center">
            <div class="w-full flex flex-col gap-2 md:flex-row md:items-center md:justify-between mt-1">
                ...
                <div class="flex flex-wrap gap-2 md:flex-row md:gap-3 mt-2 md:mt-0">
                    ...
                    <a href="{{ route('customer') }}" class="flex items-center gap-1 px-3 h-9 md:h-[50px] rounded-md md:rounded-xl bg-[#1E40AF] text-white text-[10px] md:text-[10px]">
                        <span>
            ...
            <div class="hidden md:flex flex-col justify-center w-full gap-1 mt-2 ">
                <div class="hidden md:flex text-center  text-lg ">
                    <table class="w-full text-center border-collapse border-b-2 border-blue-800 ">
                        <tr class="bg-[#1E40AF] " >
                            <th class="p-4 text-[12px]  text-white">آیدی</th>
                            <th class="p-4 text-[12px]  text-white">عکس</th>
                            <th class="p-4 text-[12px]   text-white">نام کامل</th>
                            <th class="p-4 text-[12px]   text-white">شماره</th>
                            <th class="p-4 text-[12px]   text-white">آدرس</th>
                            <th class="p-4 text-[12px]   text-white">آیدی شناسنامه</th>
                            <th class="p-4 text-[12px]   text-white">نوع مشتری </th>
                            <th class="p-4 text-[12px]   text-white">ادمین  </th>
                            <th class="p-4 text-[12px]   text-white">ادیت</th>
                            <th class="p-4 text-[12px]  text-white">چاپ</th>
                            <th class="p-4 text-[12px]  text-white">حذف</th>
                        </tr>
                        <tbody>
                            ...
                            <tr class="pt-4 text-[10px]">
                                ...
                                <td class="text-center border-b-2 border-blue-800">
                                    ...
                                    @else
                                        <div class="flex items-center justify-center w-10 h-10 mx-auto rounded-full bg-blue-800 text-white font-bold">
                ...
                <div class="sm:flex flex-wrap gap-1 justify-start hidden items-center mt-3 text-[10px]">
                    ...
                    <span class="mx-2 text-sm font-medium">
                        {{ $customers->currentPage() }} از {{ $customers->lastPage() }}
                    </span>
                    <button
                        wire:click="nextPage"
                        @disabled($customers->onLastPage())
                        class="px-2 py-1 text-sm bg-blue-800 text-white rounded disabled:opacity-50">
                        بعدی
                    </button>
                    @endif
            ...
            <div class="container flex flex-col gap-2 md:hidden text-[10px] w-full bg-white" >
                ...
                <div class="rounded-2xl flex flex-col items-center mt-1 border border-[#1E40AF66] h-auto w-full">
                    <table dir="ltr" class="w-full table-fixed items-center font-semibold justify-center text-center mx-auto">
                        ...
                        <tr>
                            <th colspan="2">ادمین</th>
                        </tr>
                        <tr  class="text-[#00000080] text-center">
                            <td colspan="2"  class="text-[10px]"> @if($customer->admin)     {{ $customer->admin->name }} ({{ $customer->admin->rule }})  @else     -- @endif
                        </tr>
                    </table>
