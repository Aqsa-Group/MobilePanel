            ...
            <div class="flex-1 lg:w-5/12 flex items-start justify-center sm:p-4 order-1 lg:order-1 animate-fade-in delay-200">
                <div class="w-full max-w-md">
                    ...
                    <form wire:submit.prevent="nextStep" enctype="multipart/form-data">
                        @csrf
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-y-6 gap-3">
                            ...
                            <div class="relative w-full">
                                <select wire:model="brand" class="input-field">
                            ...
                            <div class="relative w-full">
                                ...
                                @error('memory') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                        ...
                        <button type="submit"
                            class="w-full sm:w-[48%] py-3 rounded-xl bg-[#1100FF] text-white text-base font-semibold hover:bg-blue-700">
                            مرحله بعدی
                        </button>
                        </div>
                    </form> 
