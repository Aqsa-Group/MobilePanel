<div class="w-full">
    <main>
        <div class="p-4  max-w-full mx-auto">
            ...
            <div class="rounded-xl shadow-xl w-full shadow-[0px_4px_4px_0px_#00000040] bg-[#fafafa] px-2 py-4">
                <div class="">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 mt-4 gap-2">
                        <div class="relative">
                            ...
                            <div class="absolute left-2 top-10">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M11.74 17.7504H17.66C17.57 17.8304 17.48 17.9004 17.39 17.9804L13.12 21.1803C11.71 22.2303 9.41001 22.2303 7.99001 21.1803L3.71001 17.9804C2.77001 17.2804 2 15.7304 2 14.5604V7.15035C2 5.93035 2.93001 4.58035 4.07001 4.15035L9.05 2.28035C9.87 1.97035 11.23 1.97035 12.05 2.28035L17.02 4.15035C17.97 4.51035 18.78 5.51035 19.03 6.53035H11.73C11.51 6.53035 11.31 6.54036 11.12 6.54036C9.27 6.65036 8.78999 7.32035 8.78999 9.43035V14.8603C8.79999 17.1603 9.39001 17.7504 11.74 17.7504Z" stroke="#292D32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M8.7998 11.2207H21.9998" stroke="#292D32" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                        ...
                        <div class="relative">
                            ...
                            <div class="absolute left-2 top-10">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path d="M13.7002 4.4502L17.6802 6.75018L21.6202 4.46021" stroke="#292D32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M17.6802 10.8203V6.74023" stroke="#292D32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M16.7401 2.21L14.3401 3.53996C13.8001 3.83996 13.3501 4.59995 13.3501 5.21995V7.75999C13.3501 8.37999 13.7901 9.13998 14.3401 9.43998L16.7401 10.77C17.2501 11.06 18.0901 11.06 18.6101 10.77L21.0101 9.43998C21.5501 9.13998 22.0001 8.37999 22.0001 7.75999V5.21995C22.0001 4.59995 21.5601 3.83996 21.0101 3.53996L18.6101 2.21C18.1001 1.93 17.2601 1.93 16.7401 2.21Z" stroke="#292D32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        ...
                        <div class="relative">
                         ...
                         <div class="relative">
                            ...
                            <div class="absolute left-2 top-10">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M10.7516 16.8604V18.8904C10.7516 20.6104 9.15158 22.0004 7.18158 22.0004C5.21158 22.0004 3.60156 20.6104 3.60156 18.8904V16.8604C3.60156 18.5804 5.20158 19.8004 7.18158 19.8004C9.15158 19.8004 10.7516 18.5704 10.7516 16.8604Z" stroke="#292D32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M10.7498 14.1097C10.7498 14.6097 10.6098 15.0697 10.3698 15.4697C9.77981 16.4397 8.5698 17.0497 7.1698 17.0497C5.7698 17.0497 4.55979 16.4297 3.96979 15.4697C3.72979 15.0697 3.58984 14.6097 3.58984 14.1097C3.58984 13.2497 3.98982 12.4797 4.62982 11.9197C5.27982 11.3497 6.16979 11.0098 7.15979 11.0098C8.14979 11.0098 9.03982 11.3597 9.68982 11.9197C10.3498 12.4697 10.7498 13.2497 10.7498 14.1097Z" stroke="#292D32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M10.7516 14.11V16.86C10.7516 18.58 9.15158 19.8 7.18158 19.8C5.21158 19.8 3.60156 18.57 3.60156 16.86V14.11C3.60156 12.39 5.20158 11 7.18158 11C8.17158 11 9.06161 11.35 9.71161 11.91C10.3516 12.47 10.7516 13.25 10.7516 14.11Z" stroke="#292D32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M22.0002 10.9702V13.0302C22.0002 13.5802 21.5602 14.0302 21.0002 14.0502H19.0402C17.9602 14.0502 16.9702 13.2602 16.8802 12.1802C16.8202 11.5502 17.0602 10.9602 17.4802 10.5502C17.8502 10.1702 18.3602 9.9502 18.9202 9.9502H21.0002C21.5602 9.9702 22.0002 10.4202 22.0002 10.9702Z" stroke="#292D32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        ...
                        <div class="relative">
                            ...
                            <div class="absolute left-2 top-10">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path d="M4.58008 12H19.4201" stroke="#292D32" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                        ...
                        <div class="relative">
                            ...
                            <div class="absolute left-2 top-10">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path d="M20.75 17.5996H3.25" stroke="#292D32" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                    ...
                    <input type="submit" class="w-full hover:scale-105 transition-all duration-300 bg-[#0948EE] text-white mt-2 rounded-lg py-2 font-bold text-xl cursor-pointer" value="ثبت محصول جدید">
                </div>
            </div>
            <div class="grid grid-cols-1 w-full lg:grid-cols-2 gap-3 pt-2">
                <!-- جدول و کارت موبایل -->
                <div class="lg:col-span-2 bg-[#fafafa] rounded-2xl shadow-[0px_4px_4px_0px_#00000040] bg-[#fafafa] shadow-xl  w-full lg:max-w-full p-3">
                    <!-- کارت موبایل -->
                            ...
                            <div class="">
                                ...
                                <div class="grid grid-cols-2 gap-5 text-sm">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-gray-900 font-bold"> مبایل</div>
                                    </div>
                                    ...
                                    <div class="">
                                        ...
                                        <div class="text-gray-900 font-bold">    ؋70,000</div>
                                    </div>
                                    <div class="">
                                        <div class="text-gray-600 text-xs font-semibold mb-1">  الباقی قیمت  </div>
                                        <div class="text-gray-900 font-bold"> <span > ؋75,000</span></div>
                                    </div>
                                    <div class="">
                                        <div class="text-gray-600 text-xs font-semibold mb-1">  فایده  </div>
                                        <div class="text-gray-900 font-bold">    ؋75,000</div>
                                    </div>
                                    <div class="">
                                        <div class="text-gray-600 text-xs font-semibold mb-1">  موجودی   </div>
                                        <div class="text-gray-900 font-bold">   75</div>
                                    </div>
                                    <div class="">
                    ...
                    <div class="flex justify-between mb-3">
                        ...
                        <table class="w-full text-center border-2 border-blue-300 text-sm border-collapse">
                            <thead class=" bg-[#0B35CC]/20  border-b-2 border-blue-300 text-center">
                                            <tr>
                                                ...
                                                <th class="p-2 text-[12px]">فایده</th>
