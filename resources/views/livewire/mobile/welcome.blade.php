<div class="min-h-screen max-w-full w-full flex justify-center">
    <main class="w-full py-3 sm:py-0">
        ...
        <section class="col-span-1 lg:col-span-2 rounded-xl p-4 space-y-4">
            <aside class="col-span-1 space-y-5">
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3">
                    @php
                        $userChangePercent = 1000;
                        $isPositive = $userChangePercent >= 0;
                    @endphp
                    <div class="card-anim relative flex h-full flex-col justify-between overflow-hidden rounded-2xl border border-[#000]/20 bg-white p-4 shadow-[0_8px_24px_rgba(15,23,42,0.08)]">
                        <div class="flex items-center justify-between">
                            <div class="text-right leading-none">
                                <p class="text-xs font-bold leading-none text-[#374151]">
                                    تعداد کاربران
                                </p>
                            </div>
                            <div class="flex h-[32px] w-[32px] items-center justify-center rounded-xl bg-[#2563EB]">
                        ...
                        <div class="mt-6 flex items-end justify-between">
                            <svg width="90" height="45" viewBox="0 0 100 50">
                                ...
                                <path
                                    d="M0 40 L20 35 L40 30 L60 25 L80 18 L100 10 L100 50 L0 50 Z"
                                    fill="url(#chartGradient)"
                                />
                                <path
                                    d="M0 40 L20 35 L40 30 L60 25 L80 18 L100 10"
                                    stroke="#2563EB"
                                    stroke-width="3"
                                    fill="none"
                            ...
                            <div class="text-right">
                                <h3 class="text-sm text-center font-extrabold leading-none text-[#111827]">
                                    {{ $totalUsers }}
                                </h3>
                                <p class="text-[9px] font-semibold text-[#6B7280] mt-1">
                    ...
                    <div class="card-anim relative flex h-full flex-col justify-between overflow-hidden rounded-2xl border border-[#000]/20 bg-white p-4 shadow-[0_8px_24px_rgba(15,23,42,0.08)]">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex h-[32px] w-[32px] items-center justify-center rounded-xl bg-[#7C3AED]">
                                <svg class="h-5 w-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M9 1.25C6.37665 1.25 4.25 3.37665 4.25 6C4.25 8.62335 6.37665 10.75 9 10.75C11.6234 10.75 13.75 8.62335 13.75 6C13.75 3.37665 11.6234 1.25 9 1.25ZM5.75 6C5.75 4.20507 7.20507 2.75 9 2.75C10.7949 2.75 12.25 4.20507 12.25 6C12.25 7.79493 10.7949 9.25 9 9.25C7.20507 9.25 5.75 7.79493 5.75 6Z" fill="#ffffff"></path>
                                    <path d="M15 2.25C14.5858 2.25 14.25 2.58579 14.25 3C14.25 3.41421 14.5858 3.75 15 3.75C16.2426 3.75 17.25 4.75736 17.25 6C17.25 7.24264 16.2426 8.25 15 8.25C14.5858 8.25 14.25 8.58579 14.25 9C14.25 9.41421 14.5858 9.75 15 9.75C17.0711 9.75 18.75 8.07107 18.75 6C18.75 3.92893 17.0711 2.25 15 2.25Z" fill="#ffffff"></path>
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M3.67815 13.5204C5.07752 12.7208 6.96067 12.25 9 12.25C11.0393 12.25 12.9225 12.7208 14.3219 13.5204C15.7 14.3079 16.75 15.5101 16.75 17C16.75 18.4899 15.7 19.6921 14.3219 20.4796C12.9225 21.2792 11.0393 21.75 9 21.75C6.96067 21.75 5.07752 21.2792 3.67815 20.4796C2.3 19.6921 1.25 18.4899 1.25 17C1.25 15.5101 2.3 14.3079 3.67815 13.5204ZM4.42236 14.8228C3.26701 15.483 2.75 16.2807 2.75 17C2.75 17.7193 3.26701 18.517 4.42236 19.1772C5.55649 19.8253 7.17334 20.25 9 20.25C10.8267 20.25 12.4435 19.8253 13.5776 19.1772C14.733 18.517 15.25 17.7193 15.25 17C15.25 16.2807 14.733 15.483 13.5776 14.8228C12.4435 14.1747 10.8267 13.75 9 13.75C7.17334 13.75 5.55649 14.1747 4.42236 14.8228Z" fill="#ffffff"></path>
                                    <path d="M18.1607 13.2674C17.7561 13.1787 17.3561 13.4347 17.2674 13.8393C17.1787 14.2439 17.4347 14.6439 17.8393 14.7326C18.6317 14.9064 19.2649 15.2048 19.6829 15.5468C20.1014 15.8892 20.25 16.2237 20.25 16.5C20.25 16.7507 20.1294 17.045 19.7969 17.3539C19.462 17.665 18.9475 17.9524 18.2838 18.1523C17.8871 18.2717 17.6624 18.69 17.7818 19.0867C17.9013 19.4833 18.3196 19.708 18.7162 19.5886C19.5388 19.3409 20.2743 18.9578 20.8178 18.4529C21.3637 17.9457 21.75 17.2786 21.75 16.5C21.75 15.6352 21.2758 14.912 20.6328 14.3859C19.9893 13.8593 19.1225 13.4783 18.1607 13.2674Z" fill="#ffffff"></path>
                                </svg>
                            </div>
                        </div>
                        <div class="mt-6 flex items-end justify-between">
                            <svg width="90" height="45" viewBox="0 0 100 50" class="shrink-0">
                                <defs>
                                ...
                                <path
                                    d="M0 40 L18 36 L36 31 L54 26 L72 18 L88 14 L100 8 L100 50 L0 50 Z"
                                    fill="url(#customersChartGradient)"
                                />
                                <path
                                    d="M0 40 L18 36 L36 31 L54 26 L72 18 L88 14 L100 8"
                                    stroke="#7C3AED"
                                    stroke-width="3"
                                    fill="none"
                                    stroke-linecap="round"
                            ...
                            <div class="text-right">
                                ...
                                <p class="mt-1 text-[9px] font-semibold text-[#6B7280]">
                    ...
                    <div class="card-anim relative flex h-full flex-col justify-between overflow-hidden rounded-2xl border border-[#000]/20 bg-white p-4 shadow-[0_8px_24px_rgba(15,23,42,0.08)]">
                        ...
                        <div class="mt-6 flex items-end justify-between">
                            <svg width="90" height="45" viewBox="0 0 100 50">
                                ...
                                <path
                                    d="M0 42 L18 38 L36 34 L54 28 L72 20 L88 15 L100 10 L100 50 L0 50 Z"
                                    fill="url(#salesChartGradient)"
                                />
                                <path
                                    d="M0 42 L18 38 L36 34 L54 28 L72 20 L88 15 L100 10"
                                    stroke="#1E40AF"
                                    stroke-width="3"
                                    fill="none"
                                    stroke-linecap="round"
                    ...
                    <div class="card-anim relative flex h-full flex-col justify-between overflow-hidden rounded-2xl border border-[#000]/20 bg-white p-4 shadow-[0_8px_24px_rgba(15,23,42,0.08)]">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex h-[32px] w-[32px] items-center justify-center rounded-xl bg-[#10B981]">
                                <svg class="h-5 w-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#fff"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M11.9426 1.25H13.5C13.9142 1.25 14.25 1.58579 14.25 2C14.25 2.41421 13.9142 2.75 13.5 2.75H12C9.62178 2.75 7.91356 2.75159 6.61358 2.92637C5.33517 3.09825 4.56445 3.42514 3.9948 3.9948C3.42514 4.56445 3.09825 5.33517 2.92637 6.61358C2.75159 7.91356 2.75 9.62178 2.75 12C2.75 14.3782 2.75159 16.0864 2.92637 17.3864C3.09825 18.6648 3.42514 19.4355 3.9948 20.0052C4.56445 20.5749 5.33517 20.9018 6.61358 21.0736C7.91356 21.2484 9.62178 21.25 12 21.25C14.3782 21.25 16.0864 21.2484 17.3864 21.0736C18.6648 20.9018 19.4355 20.5749 20.0052 20.0052C20.5749 19.4355 20.9018 18.6648 21.0736 17.3864C21.2484 16.0864 21.25 14.3782 21.25 12V10.5C21.25 10.0858 21.5858 9.75 22 9.75C22.4142 9.75 22.75 10.0858 22.75 10.5V12.0574C22.75 14.3658 22.75 16.1748 22.5603 17.5863C22.366 19.031 21.9607 20.1711 21.0659 21.0659C20.1711 21.9607 19.031 22.366 17.5863 22.5603C16.1748 22.75 14.3658 22.75 12.0574 22.75H11.9426C9.63423 22.75 7.82519 22.75 6.41371 22.5603C4.96897 22.366 3.82895 21.9607 2.93414 21.0659C2.03933 20.1711 1.63399 19.031 1.43975 17.5863C1.24998 16.1748 1.24999 14.3658 1.25 12.0574V11.9426C1.24999 9.63423 1.24998 7.82519 1.43975 6.41371C1.63399 4.96897 2.03933 3.82895 2.93414 2.93414C3.82895 2.03933 4.96897 1.63399 6.41371 1.43975C7.82519 1.24998 9.63423 1.24999 11.9426 1.25Z" fill="#fff"></path> <path fill-rule="evenodd" clip-rule="evenodd" d="M15.25 5C15.25 2.92893 16.9289 1.25 19 1.25C21.0711 1.25 22.75 2.92893 22.75 5C22.75 7.07107 21.0711 8.75 19 8.75C16.9289 8.75 15.25 7.07107 15.25 5ZM19 2.75C17.7574 2.75 16.75 3.75736 16.75 5C16.75 6.24264 17.7574 7.25 19 7.25C20.2426 7.25 21.25 6.24264 21.25 5C21.25 3.75736 20.2426 2.75 19 2.75Z" fill="#fff"></path> <path d="M13.75 10C13.75 10.4142 14.0858 10.75 14.5 10.75H15.1893L13.1768 12.7626C13.0791 12.8602 12.9209 12.8602 12.8232 12.7626L11.2374 11.1768C10.554 10.4934 9.44598 10.4934 8.76256 11.1768L6.46967 13.4697C6.17678 13.7626 6.17678 14.2374 6.46967 14.5303C6.76256 14.8232 7.23744 14.8232 7.53033 14.5303L9.82322 12.2374C9.92085 12.1398 10.0791 12.1398 10.1768 12.2374L11.7626 13.8232C12.446 14.5066 13.554 14.5066 14.2374 13.8232L16.25 11.8107V12.5C16.25 12.9142 16.5858 13.25 17 13.25C17.4142 13.25 17.75 12.9142 17.75 12.5V10C17.75 9.58579 17.4142 9.25 17 9.25H14.5C14.0858 9.25 13.75 9.58579 13.75 10Z" fill="#fff"></path> </g></svg>
                            </div>
                        </div>
                        <div class="mt-6 flex items-end justify-between">
                            <svg width="90" height="45" viewBox="0 0 100 50">
                                <defs>
                                    <linearGradient id="profitChartGradient" x1="0" y1="0" x2="0" y2="1">
                                        <stop offset="0%" stop-color="#10B981" stop-opacity="0.35"/>
                                        <stop offset="100%" stop-color="#10B981" stop-opacity="0"/>
                                    </linearGradient>
                                </defs>
                                <path
                                    d="M0 42 L18 36 L36 30 L54 24 L72 16 L88 12 L100 8 L100 50 L0 50 Z"
                                    fill="url(#profitChartGradient)"
                                />
                                <path
                                    d="M0 42 L18 36 L36 30 L54 24 L72 16 L88 12 L100 8"
                                    stroke="#10B981"
                                    stroke-width="3"
                                    fill="none"
                                    stroke-linecap="round"
                    ...
                    <div class="card-anim relative flex h-full flex-col justify-between overflow-hidden rounded-2xl border border-[#000]/20 bg-white p-4 shadow-[0_8px_24px_rgba(15,23,42,0.08)]">
                        ...
                        <div class="mt-6 flex items-end justify-between">
                            <svg width="90" height="45" viewBox="0 0 100 50">
                                ...
                                <path
                                    d="M0 42 L18 39 L36 35 L54 30 L72 24 L88 18 L100 12 L100 50 L0 50 Z"
                                    fill="url(#inventoryGradient)"
                                />
                                <path
                                    d="M0 42 L18 39 L36 35 L54 30 L72 24 L88 18 L100 12"
                                    stroke="#F59E0B"
                                    stroke-width="3"
                                    fill="none"
                                    stroke-linecap="round"
                            ...
                            <div class="text-left">
                                <h3 class="text-sm font-extrabold leading-none text-[#111827]">
                    ...
                    <div class="card-anim relative flex h-full flex-col justify-between overflow-hidden rounded-2xl border border-[#000]/20 bg-white p-4 shadow-[0_8px_24px_rgba(15,23,42,0.08)]">
                        ...
                        <div class="mt-6 flex items-end justify-between">
                            <svg width="90" height="45" viewBox="0 0 100 50">
                                ...
                                <path
                                    d="M0 35 L20 32 L40 28 L60 26 L80 22 L100 18 L100 50 L0 50 Z"
                                    fill="url(#expensesGradient)"
                                />
                                <path
                                    d="M0 35 L20 32 L40 28 L60 26 L80 22 L100 18"
                                    stroke="#6366F1"
                                    stroke-width="3"
                                    fill="none"
                                    stroke-linecap="round"
                    ...
                    <div class="card-anim relative flex h-full flex-col justify-between overflow-hidden rounded-2xl border border-[#000]/20 bg-white p-4 shadow-[0_8px_24px_rgba(15,23,42,0.08)]">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex h-[32px] w-[32px] items-center justify-center rounded-xl bg-[#06B6D4]">
                        ...
                        <div class="mt-6 flex items-end justify-between">
                            <svg width="90" height="45" viewBox="0 0 100 50">
                                ...
                                <path
                                    d="M0 30 L20 28 L40 26 L60 23 L80 20 L100 18 L100 50 L0 50 Z"
                                    fill="url(#employeeGradient)"
                                />
                                <path
                                    d="M0 30 L20 28 L40 26 L60 23 L80 20 L100 18"
                                    stroke="#06B6D4"
                                    stroke-width="3"
                                    fill="none"
                                    stroke-linecap="round"
            ...
            <div class=" grid grid-cols-1 md:grid-cols-2 xl:grid-cols-2 gap-5">
                <div class="card-anim bg-white shadow-[0px_4px_4px_0px_#00000040]  border border-[#000]/20 shadow-xl rounded-xl p-4 sm:p-5">
