                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                    <div class="card-anim relative bg-[#616161]/5 shadow-xl p-4 pb-[70px] flex flex-col justify-between rounded-xl shadow-[0px_4px_4px_0px_#00000040] overflow-hidden">
                        <div class="flex items-start justify-between">
                            <div>
                                <!-- عدد بزرگ -->
                                <h3 class="text-3xl text-[#0746F7] sm:text-3xl lg:text-4xl font-bold leading-none">
                                    10
                                </h3>
                            ...
                            <svg class=" p-1 " width="45" height="45" viewBox="0 0 24 24" fill="none"
                                ...
                                <path d="M9.16006 10.87C9.06006 10.86 8.94006 10.86 8.83006 10.87C6.45006 10.79 4.56006 8.84 4.56006 6.44C4.56006 3.99 6.54006 2 9.00006 2C11.4501 2 13.4401 3.99 13.4401 6.44C13.4301 8.84 11.5401 10.79 9.16006 10.87Z"
                                    stroke="#0746F7" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        ...
                        <!-- نوار پایین (برای محتوای دلخواه) -->
                        <div class="absolute bottom-0 left-0 w-full h-[55px] bg-[#0746F7] flex items-center px-4">
                            <!-- اینجا هرچی خواستی اضافه کن -->
                    ...
                    <div class="card-anim relative bg-[#616161]/5 shadow-xl p-4 pb-[70px] flex flex-col justify-between rounded-xl shadow-[0px_4px_4px_0px_#00000040] overflow-hidden">
                        <div class="flex items-start justify-between">
                            <div>
                                <!-- عدد بزرگ -->
                                <h3 class="text-3xl sm:text-3xl lg:text-4xl font-bold leading-none text-[#0746F7]">
                                    10
                                </h3>
                            ...
                            <!-- آیکون (همان آیکون خودت، فقط بزرگ‌تر و مرتب) -->
                    ...
                    <div class="card-anim relative bg-[#616161]/5 shadow-xl p-4 pb-[70px] flex flex-col justify-between rounded-xl shadow-[0px_4px_4px_0px_#00000040] overflow-hidden">
                        ...
                        <div class="flex items-start justify-between">
                            ...
                            <svg
                                ...
                                viewBox="0 0 35 35"
                                fill="none"
                                xmlns="http://www.w3.org/20746F7/svg"
                            >
                    ...
                    <div class="card-anim relative bg-[#616161]/5 shadow-xl p-4 pb-[70px] flex flex-col justify-between rounded-xl shadow-[0px_4px_4px_0px_#0746F70746F740] overflow-hidden">
                        ...
                        <div class="flex items-start justify-between">
                            ...
                            >
                                <g clip-path="url(#clip0_862_2016)">
                                    <path d="M30.6397 16.3623V22.9102C30.6397 29.4581 28.0292 32.0832 21.4667 32.0832H13.6063C12.7605 32.0832 11.9875 32.0395 11.2729 31.9374" stroke="#0746F7" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M4.43311 22.6332V16.3623" stroke="#0746F7" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M17.5438 17.4998C20.2125 17.4998 22.1813 15.327 21.9188 12.6582L20.9416 2.9165H14.1313L13.1542 12.6582C12.8917 15.327 14.875 17.4998 17.5438 17.4998Z" stroke="#0746F7" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M26.7312 17.4998C29.6771 17.4998 31.8354 15.1081 31.5437 12.1769L31.1353 8.16647C30.6103 4.3748 29.152 2.9165 25.3312 2.9165H20.8833L21.9042 13.1394C22.1667 15.5457 24.325 17.4998 26.7312 17.4998Z" stroke="#0746F7" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M8.26886 17.4998C10.6751 17.4998 12.848 15.5457 13.0813 13.1394L13.4022 9.91657L14.1022 2.9165H9.65429C5.83346 2.9165 4.37515 4.3748 3.85015 8.16647L3.44178 12.1769C3.15011 15.1081 5.32302 17.4998 8.26886 17.4998Z" stroke="#0746F7" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="