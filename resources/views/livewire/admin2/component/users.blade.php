                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="relative">
                            <input
                                type="button"
                                wire:click="cancel"
                                class="hover:bg-red-800 transition-all duration-300 cursor-pointer bg-[#E20808] text-white text-md font-bold rounded-lg pr-3 py-4 w-full"
                                value="لغو"
                            >
                        </div>
                        <div class="relative">
                            <input
                                type="submit"
                                class="hover:bg-blue-800 transition-all duration-300 cursor-pointer bg-[#0441E4] text-white text-md font-bold rounded-lg pr-3 py-4 w-full"
                                value="{{ $mode === 'edit' ? 'ویرایش' : 'ثبت' }}"
                            >
                        </div>
                    </div>
                </form>
