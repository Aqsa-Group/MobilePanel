<div>
    <div class="max-w-full pt-4 sm:p-0 mx-auto pb-4 px-4 w-full">
        <div class="md:grid w-full grid-cols-6 gap-4">
            <div class="col-span-4">
                <!-- Table  -->
                <div class=" rounded-xl shadow-[0px_4px_4px_0px_#00000040] shadow-xl">
                    <div class="bg-[#0B35CC0D] rounded-t-xl p-4">
                        <div class="flex justify-between">
                            <h1 class="font-bold text-2xl">لیست دستگاه ها:</h1>
                            <div class="relative">
                                <input type="text" name="" id="" class="py-2 md:py-3 pr-3 bg-blue-200 rounded-lg w-26 md:w-80 outline-none" placeholder="جستجو...">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-8 mt-4">
                            <div class="p-2  bg-blue-200 rounded-lg">
                                <select name="" id="" class=" py-4 w-full bg-blue-200 outline-none">
                            ...
                            <div class="bg-[#0B35CC] text-white py-4 rounded-lg flex gap-1 items-center justify-center">
                    ...
                    <div id="div1" class="transition-all duration-300 pb-3">
                        <div class="mx-2 rounded-lg border border-[#0B35CC] mt-4">
                            <div class="hidden md:grid grid-cols-12 items-center bg-[#0B35CC] text-white rounded-tr-lg rounded-tl-lg py-4 ">
                            ...
                            <div class="cursor-pointer md:grid grid-cols-12 items-center md:mt-0 mt-0 py-2 hover:bg-gray-200 border-b  border-[#0B35CC]" onclick="handleClickDiv1()">
                                ...
                                <div class="col-span-2 text-center">
                                    ...
                                    <div class="border  border-gray-400 p-2 w-16 rounded-lg mx-auto my-2 md:my-0"><p class="text-sm">فعال</p></div>
                                </div>
                            ...
                            <div class="cursor-pointer md:grid grid-cols-12 items-center md:mt-0 mt-0 py-2 hover:bg-gray-200" onclick="handleClickDiv1()">
                                <div class="hidden md:flex text-center mx-auto"><p class="text-sm">1</p></div>
                                <div class="flex justify-center items-center"><img src="https://i.postimg.cc/9FWg4f9C/1e87ff03-ca75-4921-ab08-3a5b5d3f0acf.jpg" alt="" class="w-14 h-14 rounded-full"></div>
                                <div class="col-span-2 text-center"><p class="text-sm">A20</p></div>
                                <div class="col-span-4 grid grid-cols-3 md:grid-cols-4 my-3 md:my-0 justify-center">
                    ...
                    <div id="div2" class="hidden mt-4 transition-all duration-300 pb-2">
                        <div onclick="handleClickBack()" class="relative mx-2 rounded-lg border border-[#0B35CC] mt-1 pt-5 px-4 pb-4">
                            <!-- Details  -->
                            ...
                            <div class="rounded-xl shadow-[0px_4px_4px_0px_#00000040] shadow-xl pt-5 px-4 pb-5">
                                ...
                                <div class="flex justify-center my-4">
                                    <button class="w-48 border border-[#0B35CC] rounded-lg text-center py-3 cursor-pointer">مشخصات مشتری</button>
                                </div>
