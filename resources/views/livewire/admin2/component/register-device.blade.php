<div class="bg-white rounded-2xl shadow-md p-6 w-full max-w-full mx-auto mb-6">
    ...
    <form class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div class="relative w-full">
            <input type="text" placeholder="نام دستگاه"
                   class="w-full border border-gray-300 rounded-lg p-3 text-right">
            <svg class="w-5 h-5 text-gray-600 absolute top-1/2 -translate-y-1/2 left-3" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M12.91 7.83991L7.72004 13.0299C7.52004 13.2299 7.33004 13.6199 7.29004 13.8999L7.01004 15.8799C6.91004 16.5999 7.41004 17.0999 8.13004 16.9999L10.11 16.7199C10.39 16.6799 10.78 16.4899 10.98 16.2899L16.17 11.0999C17.06 10.2099 17.49 9.16991 16.17 7.84991C14.85 6.51991 13.81 6.93991 12.91 7.83991Z" stroke="#292D32" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M12.17 8.57983C12.61 10.1498 13.84 11.3898 15.42 11.8298" stroke="#292D32" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
        </div>
        <!-- برند -->
        <div class="relative w-full">
             <input type="text" placeholder=" برند"
                   class="w-full border border-gray-300 rounded-lg p-3 text-right text-gray-500">
            <svg class="w-5 h-5 text-gray-600 absolute top-1/2 -translate-y-1/2 left-3" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="relative w-full">
            <input type="text" placeholder="شماره IMEI"
                   class="w-full border border-gray-300 rounded-lg p-3 text-right text-gray-500">
            <svg class="w-5 h-5 text-gray-600 absolute top-1/2 -translate-y-1/2 left-3" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M3.67004 2.5V14.47C3.67004 15.45 4.13004 16.38 4.92004 16.97L10.13 20.87C11.24 21.7 12.77 21.7 13.88 20.87L19.09 16.97C19.88 16.38 20.34 15.45 20.34 14.47V2.5H3.67004Z" stroke="#292D32" stroke-width="1.5" stroke-miterlimit="10"/>
        ...
        <!-- فروشگاه -->
        <div class="relative w-full">
             <input type="text" placeholder=" فروشگاه"
                   class="w-full border border-gray-300 rounded-lg p-3 text-right text-gray-500">
            <svg class="w-5 h-5 text-gray-600 absolute top-1/2 -translate-y-1/2 left-3" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M19.9201 8.94995L13.4001 15.47C12.6301 16.24 11.3701 16.24 10.6001 15.47L4.08008 8.94995" stroke="#292D32" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
        ...
        <!-- تاریخ ثبت -->
        <div class="relative w-full" >
            <input  class="w-full border border-gray-300 rounded-lg p-3 text-right text-gray-500" placeholder="تاریخ ثبت">
            <svg class="w-5 h-5 text-gray-600 absolute top-1/2 -translate-y-1/2 left-3" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M18.7001 16.28C19.0001 17.36 19.8401 18.2 20.9201 18.5" stroke="#292D32" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <!-- عکس دستگاه -->
        <div class="relative w-full" >
            <input  class="w-full border border-gray-300 rounded-lg p-3 text-right text-gray-500" placeholder=" آپلود عکس">
            <svg class="w-5 h-5 text-gray-600 absolute top-1/2 -translate-y-1/2 left-3" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <!-- گارانتی -->
        <div class="relative w-full">
            <input type="text" placeholder="گارانتی"
                   class="w-full border border-gray-300 rounded-lg p-3 text-right">
            <svg class="w-5 h-5 text-gray-600 absolute top-1/2 -translate-y-1/2 left-3" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M12 9.69995L11.06 11.34C10.85 11.7 11.02 12 11.44 12H12.56C12.98 12 13.15 12.3 12.94 12.66L12 14.3" stroke="#292D32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
        </div>
        <!-- نام مشتری -->
        <div class="relative w-full">
            <input type="text" placeholder="نام مشتری"
                   class="w-full border border-gray-300 rounded-lg p-3 text-right">
            <svg class="w-5 h-5 text-gray-600 absolute top-1/2 -translate-y-1/2 left-3" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <!-- عکس مشتری -->
        <div class="relative w-full">
            <input  class="w-full border border-gray-300 rounded-lg p-3" placeholder=" آپلود عکس مشتری">
            <svg class="w-5 h-5 text-gray-600 absolute top-1/2 -translate-y-1/2 left-3" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M9 10C10.1046 10 11 9.10457 11 8C11 6.89543 10.1046 6 9 6C7.89543 6 7 6.89543 7 8C7 9.10457 7.89543 10 9 10Z" stroke="#292D32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <!-- آدرس مشتری -->
        <div class="relative w-full">
            <input type="text" placeholder="آدرس مشتری"
                   class="w-full border border-gray-300 rounded-lg p-3 text-right">
            <svg class="w-5 h-5 text-gray-600 absolute top-1/2 -translate-y-1/2 left-3"  viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M2 22H22" stroke="#292D32" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M2.94995 22L2.99995 9.96999C2.99995 9.35999 3.28995 8.78004 3.76995 8.40004L10.77 2.95003C11.49 2.39003 12.5 2.39003 13.23 2.95003L20.23 8.39003C20.72 8.77003 21 9.34999 21 9.96999V22" stroke="#292D32" stroke-width="1.5" stroke-miterlimit="10" stroke-linejoin="round"/>
