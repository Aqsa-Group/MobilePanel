        ...
        <div class="flex items-center justify-between h-20">
          ...
          تماس با ما
            ...
            <div class="hidden md:flex items-center gap-2">
                @auth
                    <a href="{{ route('website.my-reports') }}" class="button1 hidden md:flex items-center gap-1 bg-[#2F25FF] rounded-full text-white sm:px-4 sm:py-2 sm:rounded-xl text-sm font-bold">
                        <span class="hidden md:inline">گزارشات من</span>
                    </a>
                @else
                    <a href="{{ route('website.signup') }}" class="button1 hidden md:flex items-center gap-1 bg-white border border-[#2F25FF] text-[#2F25FF] rounded-full sm:px-4 sm:py-2 sm:rounded-xl text-sm font-bold">
                        <span class="hidden md:inline">ثبت نام</span>
                    </a>
            ...
            <div class="flex items-center gap-2 md:hidden">
                @auth
                    <a href="{{ route('website.my-reports') }}" class="button2 bg-[#2F25FF] rounded-full text-white text-sm font-bold px-3">
                        گزارشات
                    </a>
                @else
     ...
     <div id="mobileMenu"
        ...
        <nav class="flex flex-col items-center justify-center p-4 space-y-4 text-gray-700">
          ...
          تماس با ما
            ...
            @guest
                <a href="{{ route('website.signup') }}" class="text-sm text-[#2F25FF] font-bold">ثبت نام</a>
                <a href="{{ route('website.login') }}" class="text-sm text-[#2F25FF] font-bold">ورود</a>
            @endguest
            @auth
                <a href="{{ route('website.my-reports') }}" class="text-sm text-[#2F25FF] font-bold">گزارشات من</a>
            @endauth
        </nav>
    </div>
